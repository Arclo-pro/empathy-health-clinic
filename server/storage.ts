  ...
  private initializeDefaultContent() {
    ...
    const defaultTreatments: InsertTreatment[] = [
      ...
      },
      {
        ...
        description: "If you’re struggling with focus, organization, or completing tasks, it may feel like these challenges are constantly holding you back in your daily life. At Empathy Health Clinic in Winter Park, FL, we understand how overwhelming it can be to manage these symptoms without answers or support. That’s why we offer comprehensive ADHD Testing & Evaluation services designed to give you clarity, confidence, and a path forward. Whether you suspect ADHD or are seeking a second opinion, our caring team of mental health professionals is here to guide you every step of the way.\n\nOur ADHD psychiatrists and specialists are highly trained in using evidence-based assessment tools to deliver accurate diagnoses for children, teens, and adults. You can expect a thorough, personalized evaluation tailored to your unique needs. From identifying symptoms to understanding how ADHD may be impacting your life, we take the time to listen to your concerns and provide meaningful insights. We don’t just focus on diagnosis; we focus on helping you understand yourself better and empowering you to thrive. ADHD Testing & Evaluation at Empathy Health Clinic is not a one-size-fits-all approach—it’s a compassionate process designed around you.\n\nFollowing your evaluation, our team works closely with you to develop a treatment plan that fits your lifestyle and goals. Treatment options may include medication management, behavioral strategies, and practical tools to improve focus, organization, and emotional regulation. We believe effective ADHD treatment goes beyond symptom management—it’s about helping you build the skills and confidence needed to succeed at school, work, and home. Our mental health specialists provide ongoing support, ensuring that your care evolves as your needs change.\n\nScheduling ADHD Testing & Evaluation at Empathy Health Clinic is simple and convenient. We accept most major insurance plans and offer same-week appointments, making it easy for you to get the care you need without unnecessary delays. Our team understands the challenges ADHD can bring, and we are committed to making this process as seamless and stress-free as possible.\n\nAt Empathy Health Clinic, we’re more than just a mental health clinic—we’re a partner in your wellness journey. If you’re ready to take the first step toward understanding and managing ADHD, contact us today to schedule your evaluation. You deserve compassionate care and effective solutions that help you lead a fulfilling, balanced life. Let us help you unlock your potential and take control of your mental health in Winter Park, FL.",
