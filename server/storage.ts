  ...
  private initializeDefaultContent() {
    ...
    const defaultTreatments: InsertTreatment[] = [
      ...
      },
      {
        ...
        icon: "Activity",
        slug: "adhd-treatment",
        pageTitle: "ADHD Testing & Evaluation Winter Park FL | ADHD Specialist Near Me",
        heroTitle: "ADHD Testing, Evaluation & Treatment in Winter Park",
        heroDescription: "Looking for ADHD testing near you? Our board-certified ADHD specialists in Winter Park provide comprehensive ADHD evaluations, accurate diagnosis, and personalized treatment for children, teens, and adults. Same-week appointments available. Call 386-848-8751.",
        description: "Struggling with focus, organization, or completing tasks? Empathy Health Clinic offers comprehensive ADHD testing and evaluation services in Winter Park, FL. Our experienced ADHD psychiatrists and specialists use evidence-based assessment tools to provide accurate ADHD diagnosis for children, teens, and adults. We accept most major insurance plans and offer same-week appointments for ADHD evaluations. Whether you're seeking an initial ADHD assessment or a second opinion, our team provides thorough testing, clear diagnosis, and effective treatment including medication management and behavioral strategies to help you thrive at school, work, and home.",
    ...
    const defaultLocations: InsertLocation[] = [
      ...
      },
      {
        ...
        description: "When you need a trusted psychiatrist in Orlando, FL, Empathy Health Clinic provides expert psychiatric care for adults and adolescents. Our board-certified psychiatrists specialize in diagnosing and treating depression, anxiety disorders, ADHD, bipolar disorder, PTSD, and other mental health conditions. We offer comprehensive psychiatric evaluations, medication management, and ongoing support to help Orlando residents achieve optimal mental health. With convenient telehealth appointments and same-week availability, accessing quality psychiatric care in Orlando has never been easier.",
        servicesOffered: JSON.stringify([
      ...
      },
      {
        ...
        description: "Residents of Altamonte Springs seeking quality psychiatric care trust Empathy Health Clinic for comprehensive mental health treatment. Our psychiatrists provide expert diagnosis and treatment for depression, anxiety, ADHD, bipolar disorder, OCD, PTSD, and other mental health conditions. We understand that finding the right psychiatrist in Altamonte Springs is important, which is why we take time to listen, provide thorough evaluations, and develop personalized treatment plans tailored to your needs. With convenient telehealth options and acceptance of most major insurance plans, accessing psychiatric care in Altamonte Springs is easy and affordable.",
        servicesOffered: JSON.stringify([
      ...
      },
      {
        ...
        description: "Empathy Health Clinic brings experienced psychiatric care to Maitland, FL. Our board-certified psychiatrists provide comprehensive mental health services including psychiatric evaluations, medication management, and ongoing treatment for depression, anxiety, ADHD, bipolar disorder, and other conditions. We believe in a patient-centered approach that combines clinical expertise with compassionate care. Whether you're seeking a new psychiatrist in Maitland or need help managing an existing mental health condition, our team is here to support your journey to wellness. We make psychiatric care convenient with telehealth options, flexible scheduling, and acceptance of most insurance plans.",
        servicesOffered: JSON.stringify([
      ...
      },
      {
        ...
        description: "Finding a qualified psychiatrist in Casselberry, FL is easy with Empathy Health Clinic. Our experienced psychiatric team provides comprehensive mental health care for residents of Casselberry and surrounding areas. We specialize in treating depression, anxiety disorders, ADHD, bipolar disorder, PTSD, OCD, and other mental health conditions through expert medication management and personalized treatment plans. Our Casselberry psychiatry services include thorough psychiatric evaluations, medication monitoring, and ongoing support to help you achieve lasting mental wellness. With telehealth convenience, same-week appointments, and acceptance of most insurance plans, quality psychiatric care has never been more accessible.",
        servicesOffered: JSON.stringify([
      ...
      },
      {
        ...
        description: "Lake Mary residents trust Empathy Health Clinic for comprehensive psychiatric care. Our board-certified psychiatrists provide expert diagnosis and treatment for depression, anxiety, ADHD, bipolar disorder, and other mental health conditions. We understand that seeking psychiatric help is a significant step, and we're here to support you with compassionate, evidence-based care. Our Lake Mary psychiatry services include detailed psychiatric evaluations, medication management, treatment adjustment, and ongoing monitoring to ensure optimal results. Whether you're dealing with a new mental health concern or seeking better management of an existing condition, our psychiatrists are here to help. We offer convenient telehealth appointments and accept most major insurance plans.",
        servicesOffered: JSON.stringify([
          "Psychiatric Evaluations",
