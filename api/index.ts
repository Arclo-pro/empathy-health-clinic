  ...
  try {
    ...
    if (path === '/api/insurance-providers') {
      ...
      const logoMap: Record<string, string> = {
        ...
        'first health': '/site-assets/logos/firsthealth.webp',
