...
const LINK_CATEGORIES = {
  ...
  locations: [
    ...
    { href: "/locations/maitland", label: "Maitland", description: "Maitland area psychiatric care" },
    { href: "/locations/lake-mary", label: "Lake Mary", description: "North Seminole County" },
    { href: "/locations/longwood", label: "Longwood", description: "Central Seminole County" },
    { href: "/locations/sanford", label: "Sanford", description: "Historic Sanford area" },
    { href: "/locations/casselberry", label: "Casselberry", description: "South Seminole County" },
    { href: "/therapy-oviedo", label: "Oviedo", description: "UCF and Oviedo area" },
    ...
    { href: "/locations/dr-phillips", label: "Dr. Phillips", description: "Southwest Orlando area" },
    { href: "/locations/lake-nona", label: "Lake Nona", description: "Medical City area" },
  ],
  insurance: [
