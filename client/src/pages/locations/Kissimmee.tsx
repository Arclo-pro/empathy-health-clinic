...
export default function PsychiatristKissimmee() {
  const jsonLd = {
    ...
    "name": "Empathy Health Clinic - Psychiatrist Kissimmee FL",
    "description": "Board-certified psychiatrists serving Kissimmee, FL. Medication management, psychiatric evaluations, ADHD, anxiety, depression treatment. Same-week appointments. Most insurance accepted.",
  ...
  const handlePhoneClick = () => {
    trackEvent('phone_click', 'conversion', 'Psychiatrist Kissimmee Page', '386-848-8751');
  };

  return (
    <div className="min-h-screen flex flex-col bg-background">
      <SEOHead
        title="Psychiatrist Kissimmee FL | Board-Certified | Empathy Health Clinic"
        description="Top-rated psychiatrists serving Kissimmee, FL. Same-week appointments for medication management, ADHD, anxiety, depression treatment. Convenient to I-4. Most insurance accepted. Call 386-848-8751."
      ...
      <main className="flex-1">
        <HeroBackground imageSrc={heroImage}>
          ...
          <p className="text-lg md:text-xl text-white/90 leading-relaxed mb-8 max-w-3xl" data-testid="text-hero-description">
            Expert psychiatric care serving Kissimmee and surrounding areas. Board-certified psychiatrists providing medication management, psychiatric evaluations, and comprehensive mental health treatment. Same-week appointments available.
          </p>
          ...
          <div className="container mx-auto px-4 max-w-6xl">
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              <div className="flex items-start gap-3" data-testid="location-info">
                ...
                <div>
                  <h3 className="font-semibold text-foreground mb-1">Serving Kissimmee</h3>
            ...
            <div className="lg:col-span-2 space-y-8">
              ...
              <section>
                <h2 className="text-3xl font-sans font-bold text-foreground mb-6">
                  Expert Psychiatric Care Serving Kissimmee, FL
                </h2>
                <div className="prose prose-lg max-w-none">
                  <p className="text-foreground leading-relaxed mb-4">
                    Finding quality psychiatric care in Kissimmee just became easier. At Empathy Health Clinic, our board-certified psychiatrists provide comprehensive mental health services to residents of Kissimmee and surrounding Seminole County communities. Located just minutes from I-4 and SR 436, our Winter Park office offers convenient access for Kissimmee patients.
                  </p>
                  <p className="text-foreground leading-relaxed mb-4">
                    Our psychiatrists specialize in medication management, psychiatric evaluations, and evidence-based treatment for anxiety, depression, ADHD, bipolar disorder, and other mental health conditions. We understand that Kissimmee residents need accessible, high-quality psychiatric care without long waits or complicated referral processes.
                  </p>
                  <p className="text-foreground leading-relaxed">
                    We accept most major insurance plans and offer both in-person visits (convenient to Kissimmee via I-4) and secure telepsychiatry appointments. Same-week appointments are typically available for new patients from Kissimmee and the surrounding areas.
                  </p>
                </div>
              </section>
              ...
              <section>
                ...
                <div className="prose prose-lg max-w-none">
                  <p className="text-foreground leading-relaxed mb-4">
                    Our Kissimmee psychiatrists provide expert treatment for:
                  </p>
              ...
              <section>
                <h2 className="text-2xl font-sans font-bold text-foreground mb-4">
                  Psychiatric Services for Kissimmee Residents
                </h2>
                <div className="space-y-4">
                  ...
                  <div className="flex gap-4 p-4 bg-card rounded-lg border">
                    ...
                    <div>
                      ...
                      <p className="text-muted-foreground">
                        Convenient online psychiatry appointments from your Kissimmee home. Our HIPAA-compliant telehealth platform provides the same quality care as in-person visits with added convenience.
                      </p>
                    </div>
                  </div>
                </div>
              ...
              <section>
                <h2 className="text-2xl font-sans font-bold text-foreground mb-4">
                  Why Kissimmee Residents Choose Empathy Health Clinic
                </h2>
                <div className="prose prose-lg max-w-none">
                  <ul className="space-y-3 text-foreground">
                    ...
                    <li className="flex gap-3">
                      ...
                      <span><strong>Convenient Location</strong> - Just minutes from Kissimmee via I-4, with easy access from SR 436, making your appointments stress-free.</span>
                    </li>
                    <li className="flex gap-3">
              ...
              <section>
                ...
                <div className="space-y-4">
                  <div>
                    <h3 className="font-semibold text-foreground mb-2">How far is your office from Kissimmee?</h3>
                    <p className="text-muted-foreground">
                      Our Winter Park office is approximately 10-15 minutes from Kissimmee via I-4 or SR 436. We're conveniently located just off I-4, making it easy for Kissimmee residents to reach us for appointments.
                    </p>
                  </div>
                  <div>
                    <h3 className="font-semibold text-foreground mb-2">How quickly can I get an appointment?</h3>
                    <p className="text-muted-foreground">
                      We typically offer same-week appointments for new patients from Kissimmee. Call us at 386-848-8751 and our scheduling team will find the earliest available appointment with one of our psychiatrists.
                    </p>
                  </div>
                  <div>
                  ...
                  <div>
                    ...
                    <p className="text-muted-foreground">
                      Yes! We offer secure, HIPAA-compliant telepsychiatry appointments perfect for Kissimmee residents. Meet with your psychiatrist from home via video call while receiving the same quality care as in-person visits.
                    </p>
                  </div>
                  <div>
              ...
              <LocalizedContent 
                city="Kissimmee" 
                neighborhoods={["Downtown Kissimmee", "Poinciana", "Celebration", "St. Cloud", "Buenaventura Lakes"]}
                nearbyLandmarks={["Walt Disney World Resort", "Osceola Heritage Park", "Old Town Kissimmee", "Lakefront Park"]}
                highways={["US 192", "I-4", "SR 535", "Florida's Turnpike"]}
                description="Gateway to Central Florida theme parks with diverse Osceola County communities we proudly serve"
                driveTimeMinutes={25}
              ...
              <InternalLinkBlock 
                category="services"
                excludePaths={["/locations/kissimmee"]}
                title="Explore Our Services in Kissimmee Area"
              />
          ...
          <div className="container mx-auto px-4 max-w-2xl">
            <div className="text-center mb-8">
              ...
              <p className="text-lg text-muted-foreground">
                Serving Kissimmee residents. Same-week appointments available. Most insurance accepted.
              </p>
            </div>
            <ShortContactForm />
          </div>
