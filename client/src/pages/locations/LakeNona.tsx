...
export default function PsychiatristLakeNona() {
  const jsonLd = {
    "@context": "https://schema.org",
    "@type": ["Psychiatrist", "MedicalBusiness", "LocalBusiness"],
    "name": "Empathy Health Clinic - Psychiatrist Lake Nona FL",
    "description": "Board-certified psychiatrists serving Lake Nona, FL. Medication management, psychiatric evaluations, ADHD, anxiety, depression treatment. Same-week appointments. Most insurance accepted.",
    "url": "https://www.empathyhealthclinic.com/psychiatrist-lake-nona",
  ...
  const handlePhoneClick = () => {
    trackEvent('phone_click', 'conversion', 'Psychiatrist Lake Nona Page', '386-848-8751');
  };

  return (
    <div className="min-h-screen flex flex-col bg-background">
      <SEOHead
        title="Psychiatrist Lake Nona FL | Board-Certified | Same-Week"
        description="Top-rated psychiatrist serving Lake Nona, FL and Medical City area. Board-certified psychiatrists for medication management, ADHD, anxiety, depression. Same-week appointments. BCBS, Cigna, Aetna, Medicare accepted. Call (386) 848-8751."
      ...
      <main className="flex-1">
        <HeroBackground imageSrc={heroImage}>
          <h1 className="text-3xl md:text-4xl lg:text-6xl font-sans font-bold mb-4 text-white" data-testid="text-hero-title">
            Psychiatrist Lake Nona, FL
          </h1>
          <p className="text-lg md:text-xl text-white/90 leading-relaxed mb-8 max-w-3xl" data-testid="text-hero-description">
            Board-certified psychiatrists serving Lake Nona and Medical City. Expert medication management, psychiatric evaluations, and comprehensive mental health treatment. Same-week appointments available.
          </p>
          <div className="flex flex-wrap gap-4">
            <Button 
              ...
              onClick={() => trackEvent('lake_nona_hero_cta', 'conversion', 'Psychiatrist Lake Nona Page')}
            >
          ...
          <div className="container mx-auto px-4 max-w-6xl">
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              <div className="flex items-start gap-3" data-testid="location-info">
                ...
                <div>
                  <h3 className="font-semibold text-foreground mb-1">Serving Lake Nona</h3>
                  <p className="text-sm text-muted-foreground">
                    2281 Lee Rd Suite 102<br />
                    Winter Park, FL 32810<br />
                    (Convenient to Lake Nona via 417)
                  </p>
                  <a 
            ...
            <div className="lg:col-span-2 space-y-8">
              ...
              <section>
                <h2 className="text-3xl font-sans font-bold text-foreground mb-6">
                  Expert Psychiatrist Serving Lake Nona, FL
                </h2>
                <div className="prose prose-lg max-w-none">
                  <p className="text-foreground leading-relaxed mb-4">
                    Looking for a trusted <Link href="/psychiatrist-orlando" className="text-primary hover:underline">psychiatrist</Link> near Lake Nona? Empathy Health Clinic provides expert psychiatric care to Lake Nona residents, including those in the Medical City area, Laureate Park, and surrounding communities.
                  </p>
                  <p className="text-foreground leading-relaxed mb-4">
                    Our board-certified psychiatrists specialize in <Link href="/services" className="text-primary hover:underline">medication management</Link>, psychiatric evaluations, and evidence-based treatment for <Link href="/anxiety-therapy" className="text-primary hover:underline">anxiety</Link>, depression, <Link href="/adhd-testing-orlando" className="text-primary hover:underline">ADHD</Link>, bipolar disorder, and other mental health conditions. Lake Nona's innovative healthcare community deserves access to quality psychiatric care.
                  </p>
                  <p className="text-foreground leading-relaxed">
                    We accept most major insurance plans and offer both in-person visits and secure <Link href="/virtual-therapy" className="text-primary hover:underline">telehealth</Link> appointments - perfect for busy Lake Nona professionals. Same-week appointments are typically available for new patients.
                  </p>
                </div>
              </section>
              ...
              <section>
                ...
                <div className="prose prose-lg max-w-none">
                  <p className="text-foreground leading-relaxed mb-4">
                    Our psychiatrists serving Lake Nona provide expert treatment for:
                  </p>
              ...
              <section>
                <h2 className="text-2xl font-sans font-bold text-foreground mb-4">
                  Psychiatric Services for Lake Nona
                </h2>
                <div className="space-y-4">
                  ...
                  <div className="flex gap-4 p-4 bg-card rounded-lg border">
                    ...
                    <div>
                      ...
                      <p className="text-muted-foreground">
                        Convenient online psychiatry appointments from your Lake Nona home. Our HIPAA-compliant telehealth platform provides the same quality care as in-person visits - ideal for busy Medical City professionals.
                      </p>
                    </div>
                  </div>
                </div>
              ...
              <section>
                <h2 className="text-2xl font-sans font-bold text-foreground mb-4">
                  Why Lake Nona Residents Choose Empathy Health Clinic
                </h2>
                <div className="prose prose-lg max-w-none">
                  <ul className="space-y-3 text-foreground">
                    ...
                    <li className="flex gap-3">
                      ...
                      <span><strong>Convenient Access from Lake Nona</strong> - Easy drive via 417 and I-4 with plenty of parking available. Telehealth options perfect for Medical City residents.</span>
                    </li>
                    <li className="flex gap-3">
              ...
              <section>
                ...
                <div className="space-y-4">
                  <div>
                    <h3 className="font-semibold text-foreground mb-2">Do you have an office in Lake Nona?</h3>
                    <p className="text-muted-foreground">
                      Our main office is located at 2281 Lee Road Suite 102, Winter Park, FL 32810. We serve Lake Nona residents through both in-person appointments (easy access via 417) and convenient telepsychiatry services.
                    </p>
                  </div>
                  <div>
                  ...
                  <div>
                    <h3 className="font-semibold text-foreground mb-2">Do you offer telehealth for Lake Nona patients?</h3>
                    <p className="text-muted-foreground">
                      Yes! Many Lake Nona patients prefer our telepsychiatry services. Meet with your psychiatrist from home via secure video call while receiving the same quality care as in-person visits.
                    </p>
                  </div>
                  <div>
                  ...
                  <div>
                    <h3 className="font-semibold text-foreground mb-2">Can you treat patients from Lake Nona Medical City?</h3>
                    <p className="text-muted-foreground">
                      Absolutely! We proudly serve healthcare professionals and residents throughout Lake Nona's Medical City community with flexible scheduling and telehealth options to accommodate demanding schedules.
                    </p>
                  </div>
                </div>
              </section>
              ...
              <LocalizedContent 
                city="Lake Nona" 
                neighborhoods={["Medical City", "Laureate Park", "Tavistock", "Nona Park", "Narcoossee"]}
                nearbyLandmarks={["Lake Nona Medical City", "USTA National Campus", "Lake Nona Town Center", "Nemours Children's Hospital"]}
                highways={["417", "528", "Narcoossee Road", "Boggy Creek Road"]}
                description="Innovative community known for Medical City and cutting-edge healthcare, served by our expert psychiatric team"
                driveTimeMinutes={25}
                slug="/psychiatrist-lake-nona"
              />
            ...
            <div className="lg:col-span-1">
              <div className="sticky top-4 space-y-6">
                <div className="bg-card border rounded-lg p-6" id="contact-form">
                  ...
                  <ShortContactForm 
                    service="Psychiatrist Lake Nona"
                    className="mb-4"
                  />
        ...
        <section className="py-16 px-4 bg-gradient-to-br from-primary to-primary/80">
          <div className="container mx-auto max-w-4xl text-center text-white">
            <h2 className="text-3xl md:text-4xl font-bold mb-4">
              Ready to See a Psychiatrist Near Lake Nona?
            </h2>
            <p className="text-xl mb-8 text-white/95">
              Board-certified psychiatrists accepting new patients. Same-week appointments available with telehealth options for Lake Nona residents.
            </p>
