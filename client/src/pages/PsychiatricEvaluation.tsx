        ...
        <div className="grid lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-2">
            ...
            <p className="text-foreground leading-relaxed mb-6">
              A psychiatric evaluation, also called a mental health evaluation or psych evaluation, is a comprehensive assessment conducted by a board-certified psychiatrist to diagnose mental health conditions and develop an effective treatment plan. During your evaluation at Empathy Health Clinic in Winter Park and Orlando, your psychiatrist will review your symptoms, medical history, family mental health history, and current medications to accurately diagnose conditions like <Link href="/depression-psychiatrist-orlando" className="text-primary hover:underline font-medium">depression</Link>, <Link href="/anxiety-psychiatrist-orlando" className="text-primary hover:underline font-medium">anxiety</Link>, <Link href="/adhd-psychiatrist-orlando" className="text-primary hover:underline font-medium">ADHD</Link>, <Link href="/bipolar-psychiatrist-orlando" className="text-primary hover:underline font-medium">bipolar disorder</Link>, PTSD, and other mental health disorders.
            </p>
